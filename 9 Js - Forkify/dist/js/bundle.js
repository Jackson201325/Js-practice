! function (t) {
    ...
    var e = r(1),
        ...
        a = function (t, n, r) {
            ...
            for (f in v && (r = n), r) l = ((s = !p && m && void 0 !== m[f]) ? m : r)[f], h = y && s ? c(l, e) : g && "function" == typeof l ? c(Function.call, l) : l, m && u(m, f, l, t & a.U), x[f] != l && i(x, f, h), g && w[f] != l && (w[f] = l)
        };
    ...
    t.exports = function (t, n) {
        ...
        return function (n, c, v) {
            for (var d, g, y = i(n), m = o(y), x = e(c, v, 3), w = u(m.length), b = 0, S = r ? p(n, w) : a ? p(n, 0) : void 0; w > b; b++)
                if ((h || b in m) && (g = x(d = m[b], b, y), t))
                    if (r) S[b] = g;
                    else if (g) switch (t) {
                case 3:
                    return !0;
    ...
    if (r(8)) {
        var e = r(31),
            ...
            Pt = function (t, n) {
                if (!(b(t) && gt in t)) throw G("It is not a typed array constructor!");
                return new t(n)
            },
            At = function (t, n) {
            ...
            Nt = {
                ...
                subarray: function (t, n) {
                    var r = Ot(this),
                        e = r.length,
                        o = y(t, e);
                    return new(I(r, r[yt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : y(n, e)) - o))
                }
            },
            Lt = function (t, n) {
            ...
            Dt = function (t, n) {
                return b(t) && t[xt] && "symbol" != typeof n && n in t && String(+n) == String(n)
            },
            Bt = function (t, n) {
                return Dt(t, n = m(n, !0)) ? l(2, t[n]) : V(t, n)
            },
            Ut = function (t, n, r) {
                return !(Dt(t, n = m(n, !0)) && b(r) && x(r, "value")) || x(r, "get") || x(r, "set") || r.configurable || x(r, "writable") && !r.writable || x(r, "enumerable") && !r.enumerable ? W(t, n, r) : (t[n] = r.value, t)
            };
        ...
        p(Wt, Ct), h(Wt, vt, Ct.values), p(Wt, {
            ...
            x ? (v = r(function (t, r, e, o) {
                ...
                var i, u, c, a, l = 0,
                    p = 0;
                if (b(r)) {
                    if (!(r instanceof X || "ArrayBuffer" == (a = w(r)) || "SharedArrayBuffer" == a)) return xt in r ? Ft(v, r) : Mt.call(v, r);
                    i = r, p = Et(e, n);
                    var y = r.byteLength;
                    if (void 0 === o) {
                ...
                var i;
                return s(t, v, f), b(r) ? r instanceof X || "ArrayBuffer" == (i = w(r)) || "SharedArrayBuffer" == i ? void 0 !== o ? new y(r, Et(e, n), o) : void 0 !== e ? new y(r, Et(e, n)) : new y(r) : xt in r ? Ft(v, r) : Mt.call(v, r) : new y(g(r))
            ...
            var F = _[vt],
                ...
                M = Ct.values;
            h(v, gt, !0), h(_, xt, f), h(_, wt, !0), h(_, yt, v), (a ? new v(1)[dt] == f : dt in _) || W(_, dt, {
                get: function () {
                    return f
                }
                ...
                from: Mt,
                of: Tt
            }), "BYTES_PER_ELEMENT" in _ || h(_, "BYTES_PER_ELEMENT", n), u(u.P, f, Nt), k(f), u(u.P + u.F * _t, f, {
                set: kt
            }), u(u.P + u.F * !j, f, Ct), e || _.toString == ht || (_.toString = ht), u(u.P + u.F * i(function () {
                new v(1).slice()
            }), f, {
                slice: Lt
    ...
    var e = r(5)("unscopables"),
        o = Array.prototype;
    null == o[e] && r(14)(o, e, {}), t.exports = function (t) {
        o[e][t] = !0
    }
}, function (t, n, r) {
    "use strict";
    ...
    t.exports = function (t, n, r, d, g, y) {
        ...
        if ("function" == typeof x && (y || b.forEach && !l(function () {
            ...
            })).prototype = b, b.constructor = x), (P || F) && (_("delete"), _("has"), g && _("get")), (F || O) && _(w), y && b.clear && delete b.clear
        } else x = d.getConstructor(n, t, g, w), u(x.prototype, r), c.NEED = !0;
    ...
    t.exports = function (t, n, r, v, d, g, y) {
        ...
        var m, x, w, b = function (t) {
            ...
            A = P || b(d),
            F = d ? _ ? b("entries") : A : void 0,
            j = "Array" == n && O.entries || P;
        if (j && (w = s(j.call(new t))) !== Object.prototype && w.next && (f(w, S, !0), e || "function" == typeof w[l] || u(w, l, p)), _ && P && "values" !== P.name && (E = !0, A = function () {
                return P.call(this)
            }), e && !y || !h && !E && O[l] || u(O, l, A), c[n] = A, c[S] = p, d)
            if (m = {
                    values: _ ? A : b("values"),
                    keys: g ? A : b("keys"),
                    entries: F
    ...
    function N(t, n, r) {
        var e, o, i, u = new Array(r),
            ...
            l = 0,
            h = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for ((t = P(t)) != t || t === E ? (o = t != t ? 1 : 0, e = a) : (e = F(j(t) / M), t * (i = A(2, -e)) < 1 && (e--, i *= 2), (t += e + f >= 1 ? s / i : s * A(2, 1 - f)) * i >= 2 && (e++, i /= 2), e + f >= a ? (o = 0, e = a) : e + f >= 1 ? (o = (t * i - 1) * A(2, n), e += f) : (o = t * A(2, f - 1) * A(2, n), e = 0)); n >= 8; u[l++] = 255 & o, o /= 256, n -= 8);
    ...
    if (u.ABV) {
        if (!f(function () {
            ...
            for (var z, H = (w = function (t) {
                ...
                })[m] = O[m], X = v(O), Y = 0; X.length > Y;)(z = X[Y++]) in w || c(w, z, O[z]);
            i || (H.constructor = w)
        }
        var $ = new b(new w(2)),
            J = b[m].setInt8;
        $.setInt8(0, 2147483648), $.setInt8(1, 2147483649), !$.getInt8(0) && $.getInt8(1) || a(b[m], {
        ...
        this[T] = t, this[R] = o, this[I] = r
    }, o && (V(w, "byteLength", "_l"), V(b, "buffer", "_b"), V(b, "byteLength", "_l"), V(b, "byteOffset", "_o")), a(b[m], {
        getInt8: function (t) {
        ...
        getFloat32: function (t) {
            return L(q(this, 4, t, arguments[1]), 23, 4)
        },
        getFloat64: function (t) {
            return L(q(this, 8, t, arguments[1]), 52, 8)
        },
        setInt8: function (t, n) {
            G(this, 1, t, C, n)
        },
    ...
    y(w, "ArrayBuffer"), y(b, "DataView"), c(b[m], u.VIEW, !0), n.ArrayBuffer = w, n.DataView = b
}, function (t, n, r) {
    "use strict";
    (function (n) {
        var e = r(16),
        ...
        var c, a = {
            adapter: ("undefined" != typeof XMLHttpRequest ? c = r(118) : void 0 !== n && (c = r(118)), c),
    ...
    var e, o, i, u, c = r(31),
        ...
        T = !! function () {
            try {
                ...
                return (F || "function" == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== P.indexOf("6.6") && -1 === b.indexOf("Chrome/66")
            } catch (t) {}
        }(),
        I = function (t) {
            var n;
                ...
                m(function () {
                    for (var e = t._v, o = 1 == t._s, i = 0, u = function (n) {
                            var r, i, u, c = o ? n.ok : n.fail,
                                ...
                                s = n.domain;
                            try {
                                c ? (o || (2 == t._h && k(t), t._h = 1), !0 === c ? r = e : (s && s.enter(), r = c(e), s && (s.exit(), u = !0)), r === n.promise ? f(_("Promise-chain cycle")) : (i = I(r)) ? i.call(r, a, f) : a(r)) : f(e)
                            } catch (t) {
                                s && !u && s.exit(), f(t)
                            }
                        }; r.length > i;) u(r[i++]);
        ...
        N = function (t) {
            y.call(a, function () {
                var n, r, e, o = t._v,
                    i = L(t);
                if (i && (n = w(function () {
                        F ? E.emit("unhandledRejection", o, t) : (r = a.onunhandledrejection) ? r({
                            promise: t,
                            reason: o
    ...
    T || (A = function (t) {
        ...
        Promise: A
    }), r(38)(A, "Promise"), r(41)("Promise"), u = r(9).Promise, l(l.S + l.F * !T, "Promise", {
        reject: function (t) {
            var n = M(this);
    ...
    var e = r(16),
        ...
        c = r(300),
        a = r(119),
        f = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || r(301);
    t.exports = function (t) {
    ...
    r(124), t.exports = r(310)
}, function (t, n, r) {
    "use strict";
    (function (t) {
        r(126), r(270), r(272), r(274), r(276), r(278), r(280), r(282), r(284), r(286), r(290), t._babelPolyfill && "undefined" != typeof console && console.warn && console.warn("@babel/polyfill is loaded more than once on this page. This is probably not desirable/intended and may have consequences if different versions of the polyfills are applied sequentially. If you do need to load the polyfill more than once, use @babel/polyfill/noConflict instead to bypass the warning."), t._babelPolyfill = !0
    }).call(this, r(125))
}, function (t, n) {
    var r;
    r = function () {
    ...
    var e = r(1),
        ...
        X = function (t, n, r) {
            return t === U && X(B, n, r), m(t), n = b(n, !0), m(r), o(D, n) ? (r.enumerable ? (o(t, N) && t[N][n] && (t[N][n] = !1), r = _(r, {
                enumerable: S(0, !1)
            })) : (o(t, N) || j(t, N, S(1, {})), t[N][n] = !0), G(t, n, r)) : j(t, n, r)
        },
        Y = function (t, n) {
            m(t);
        ...
        $ = function (t) {
            ...
            return !(this === U && o(D, t) && !o(B, t)) && (!(n || !o(this, t) || !o(D, t) || o(this, N) && this[N][t]) || n)
        },
        J = function (t, n) {
            if (t = w(t), n = b(n, !0), t !== U || !o(D, n) || o(B, n)) {
                var r = F(t, n);
                return !r || !o(D, n) || o(t, N) && t[N][n] || (r.enumerable = !0), r
            }
        },
        K = function (t) {
            for (var n, r = M(w(t)), e = [], i = 0; r.length > i;) o(D, n = r[i++]) || n == N || n == a || e.push(n);
            return e
        },
        Z = function (t) {
            for (var n, r = t === U, e = M(r ? B : w(t)), i = [], u = 0; e.length > u;) !o(D, n = e[u++]) || r && !o(U, n) || i.push(D[n]);
            return i
        };
    W || (c((T = function () {
        ...
        var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function (r) {
                this === U && n.call(B, r), o(this, N) && o(this[N], t) && (this[N][t] = !1), G(this, t, S(1, r))
            };
        return i && q && G(U, t, {
            configurable: !0,
            set: n
        ...
        return this._k
    }), O.f = J, P.f = X, r(35).f = E.f = K, r(45).f = $, r(50).f = Z, i && !r(31) && c(U, "propertyIsEnumerable", $, !0), v.f = function (t) {
        return z(p(t))
    }), u(u.G + u.W + u.F * !W, {
        Symbol: T
    });
    ...
    u(u.S + u.F * !W, "Symbol", {
        ...
        stringify: function (t) {
            ...
            if (r = n = e[1], (x(n) || void 0 !== t) && !H(t)) return y(n) || (n = function (t, n) {
                if ("function" == typeof r && (n = r.call(this, t, n)), !H(n)) return n
            }), e[1] = n, R.apply(I, e)
        }
    }), T.prototype[L] || r(14)(T.prototype, L, T.prototype.valueOf), l(T, "Symbol"), l(Math, "Math", !0), l(e.JSON, "JSON", !0)
}, function (t, n, r) {
    ...
    var e = r(4),
        o = r(28).onFreeze;
    r(20)("preventExtensions", function (t) {
        return function (n) {
            return t && e(n) ? t(o(n)) : n
        }
    })
    ...
    var e = r(46),
        o = {};
    o[r(5)("toStringTag")] = "z", o + "" != "[object z]" && r(10)(Object.prototype, "toString", function () {
    ...
    if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
        ...
        for (var x, w = r(8) ? f(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), b = 0; w.length > b; b++) o(v, x = w[b]) && !o(p, x) && l(p, x, s(v, x));
    ...
    var e = r(0),
        o = r(15),
        i = [].join;
    e(e.P + e.F * (r(44) != Object || !r(17)(i)), "Array", {
        join: function (t) {
    ...
    r(55)("replace", 2, function (t, n, r, v) {
        return [function (e, o) {
            ...
            for (var w, b = "", S = 0, _ = 0; _ < m.length; _++) {
                x = m[_];
                for (var E = String(x[0]), O = f(s(u(x.index), h.length), 0), P = [], A = 1; A < x.length; A++) P.push(void 0 === (w = x[A]) ? w : String(w));
                var F = x.groups;
                if (p) {
                    var j = [E].concat(P, O, h);
                    void 0 !== F && j.push(F);
                    var M = String(n.apply(void 0, j))
                } else M = d(E, h, O, P, F, n);
                O >= S && (b += h.slice(S, O) + M, S = O + E.length)
            }
            return b + h.slice(S)
        }];
    ...
    r(55)("split", 2, function (t, n, r, s) {
        ...
        return v = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, n) {
            ...
            for (var w = 0, b = 0, S = []; b < h.length;) {
                m.lastIndex = p ? b : 0;
                var _, E = a(m, p ? h : h.slice(b));
                if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : b)), h.length)) === w) b = u(h, b, g);
                else {
    ...
    var e, o = r(1),
        ...
        x = t.exports = r(58)("WeakMap", y, m, f, !0, !0);
    ...
    r(271), t.exports = r(9).Array.includes
}, function (t, n, r) {
    "use strict";
    var e = r(0),
        o = r(49)(!0);
    ...
    r(273), t.exports = r(9).String.padStart
}, function (t, n, r) {
    "use strict";
    var e = r(0),
        o = r(115),
    ...
    r(275), t.exports = r(9).String.padEnd
}, function (t, n, r) {
    "use strict";
    var e = r(0),
        o = r(115),
    ...
    r(277), t.exports = r(61).f("asyncIterator")
}, function (t, n, r) {
    r(88)("asyncIterator")
}, function (t, n, r) {
    r(279), t.exports = r(9).Object.getOwnPropertyDescriptors
}, function (t, n, r) {
    var e = r(0),
        o = r(114),
        i = r(15),
    ...
    r(281), t.exports = r(9).Object.values
}, function (t, n, r) {
    var e = r(0),
        o = r(116)(!1);
    e(e.S, "Object", {
    ...
    r(283), t.exports = r(9).Object.entries
}, function (t, n, r) {
    var e = r(0),
        o = r(116)(!0);
    e(e.S, "Object", {
    ...
    "use strict";
    r(108), r(285), t.exports = r(9).Promise.finally
}, function (t, n, r) {
    "use strict";
    var e = r(0),
        o = r(9),
    ...
    r(287), r(288), r(289), t.exports = r(9)
}, function (t, n, r) {
    var e = r(1),
        o = r(0),
        i = r(57),
    ...
    for (var e = r(81), o = r(32), i = r(10), u = r(1), c = r(14), a = r(39), f = r(5), s = f("iterator"), l = f("toStringTag"), h = a.Array, p = {
            CSSRuleList: !0,
    ...
    ! function (n) {
        ...
        if (s) f && (t.exports = s);
            ...
            var x = E.prototype = S.prototype = Object.create(g);
            _.prototype = x.constructor = E, E.constructor = _, E[a] = _.displayName = "GeneratorFunction", s.isGeneratorFunction = function (t) {
                var n = "function" == typeof t && t.constructor;
                return !!n && (n === _ || "GeneratorFunction" === (n.displayName || n.name))
            }, s.mark = function (t) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(t, E) : (t.__proto__ = E, a in t || (t[a] = "GeneratorFunction")), t.prototype = Object.create(x), t
            }, s.awrap = function (t) {
                return {
                    __await: t
                }
    ...
    }, a.Cancel = r(121), a.CancelToken = r(308), a.isCancel = r(120), a.all = function (t) {
        return Promise.all(t)
    }, a.spread = r(309), t.exports = a, t.exports.default = a
}, function (t, n) {
    function r(t) {
    ...
    var c = function () {
                    ...
                    var t, n = (t = regeneratorRuntime.mark(function t() {
                        ...
                        return regeneratorRuntime.wrap(function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return "657d1535743fde242b2490ce214475c1", t.prev = 1, t.next = 4, o()("https://www.food2fork.com/api/search?key=".concat("657d1535743fde242b2490ce214475c1", "&q=").concat(this.query));
                                case 4:
                                    n = t.sent, this.result = n.data.recipes, t.next = 11;
                                    break;
                                case 8:
        ...
        l = function (t) {
            var n = '\n        <li>\n            <a class="results__link results__link--active" href="'.concat(t.recipe_id, '">\n                <figure class="results__fig">\n                    <img src="').concat(t.image_url, '" alt="Test">\n                </figure>\n                <div class="results__data">\n                    <h4 class="results__name">').concat(function (t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 17,
                    r = [];
                return t.length > n ? (t.split(" ").reduce(function (t, e) {
                    return t + e.length <= n && r.push(e), t + e.length
                }, 0), "".concat(r.join(" "), " ....")) : t
            }(t.title), '</h4>\n                    <p class="results__author">').concat(t.publisher, "</p>\n                </div>\n            </a>\n        </li>");
            a.searchResList.insertAdjacentHTML("beforeend", n)
        };

    function h(t, n, r, e, o, i, u) {
        try {
            var c = t[i](u),
                a = c.value
        } catch (t) {
        ...
        v = function () {
            var t, n = (t = regeneratorRuntime.mark(function t() {
                ...
                return regeneratorRuntime.wrap(function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            if (!(n = a.searchInput.value)) {
                                t.next = 11;
                                break
                            }
                            return p.search = new c(n), a.searchInput.value = "", a.searchResList.innerHTML = "", r = a.searchRes, e = void 0, e = '\n    <div class = "'.concat(f, '">\n        <svg>\n            <use href="img/icons.svg#icon-cw"></use>\n        </svg>\n    </div>\n    '), r.insertAdjacentHTML("afterbegin", e), t.next = 8, p.search.getResults();
                        case 8:
                            s(), console.log(p.search.result), p.search.result.forEach(l);
                        case 11:
                        case "end":
                            return t.stop()
                    }
    ...
    a.searchForm.addEventListener("submit", function (t) {
        t.preventDefault(), v()
    });
    var d = new c("pizza");
    console.log(d), d.getResults()
}]);